...
class Imageupload extends MY_Controller
{
    ...
    public function banners()
    {
        ...
        if($this->input->get()){
            ...
            $config['base_url']             = base_url('vnadmin/imageupload/banner?title='
            ...
            $config['base_url'] = base_url('vnadmin/imageupload/banner');
...
//        print_r($data['images']);
        ...
        if (isset($_POST['upload'])) {
            ...
            redirect(base_url('vnadmin/imageupload/banner'));
        }
        $data['procate'] = $this->imagemodel->getList('product_category');
        $data['error'] = @$error;
