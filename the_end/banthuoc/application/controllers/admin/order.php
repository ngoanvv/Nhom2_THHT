...
//        $data['cate_chil'] = $this->ordermodel->getListChil('product_category');
    ...
    {
        $config['base_url'] = base_url('vnadmin/search-by-type/'.$type);
    ...
    {
        $config['base_url'] = base_url('vnadmin/search-by-category/'.$cate);
    ...
    {
        $config['base_url'] = base_url('vnadmin/search-by-network/'.$net);
    ...
    {
        $config['base_url'] = base_url('vnadmin/search-by-price/'.$min.'/'.$max);
...
//    ======================================================================================================================
    ...
    {
        $config['base_url'] = base_url('vnadmin/product/' . $alias);
        ...
        if (isset($_POST['addnews'])) {
            ...
            if ($_FILES['userfile']['name'] != '') {
                if (!$this->upload->do_upload()) {
                    ...
                    redirect(base_url('vnadmin/danh-sach-san-pham'));
                }
            } else {
                $new = array('name' => $name,
                    'description' => $description,
        ...
        if (isset($_POST['addcate'])) {
            ...
            if ($_FILES['userfile']['name'] != '') {
                if (!$this->upload->do_upload()) {
                    ...
                    if ($id_cate)
                        redirect(base_url('vnadmin/danh-muc-san-pham'));
                }
            } else {
        ...
        foreach ($_FILES as $key => $value) {
            ...
            for ($s = 0; $s <= $count - 1; $s++) {
                ...
                if ($data['file_name'] != null) {
                    ...
                    // redirect(base_url('vnadmin/product_images/' . $id));
                }
            }
        }
