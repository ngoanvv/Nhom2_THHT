...
class Remenu{
    ...
    public function recursiveMenu($sourceArr,$parents = 0,&$newMenu,$class=''){
        ...
        if(count($sourceArr)>0){
          ...
          //  $newMenu .= '<li class="menu-item has-dropdown"><img src="img/home.png" border="0" ></li>';
            foreach ($sourceArr as $key => $value){
                if($value['parent_id'] == $parents){
                    ...
                    if($value['url'] == 'trang-chu'){
						...
						<li class="menu-item "><a class="menu-link" href="' . base_url() . '"> ' . $value['name'] . '</a>';
                    }
                    else{
                        $newMenu .= '<li class="menu-item"><a class="menu-link" href="' . base_url($value['url']) . '">' . $value['name'] . '</a>';
                    }
