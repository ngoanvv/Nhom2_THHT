    ...
    foreach ($data as $k=>$v) {
        if ($v->parent_id == $parent) {
            ...
            echo "<tr>
                    ...
                    <td>$img</td>
                    <td class=\"text-center\">
                      <a href='".base_url('vnadmin/product/editprohangsx/' . $v->id)."'
                    class=\"btn btn-xs btn-default\" title=\"Sửa\"><i class=\"fa fa-pencil\"></i></a>

                <a href='".base_url('vnadmin/product/deletehangsx/' . $v->id)."'
                       onclick=\"return confirm('Bạn có chắc chắn muốn xóa?')\"
                       class=\"btn btn-xs btn-danger\"title=\"Xóa\" style=\"color: #fff\"><i class=\"fa fa-times\"></i> </a>
                    </td>
                </tr>";
    ...
    foreach ($data as $k=>$v) {
        if ($v->parent_id == $parent) {
            ...
            echo "<tr>
                    ...
                    <td>$img</td>
                    <td class=\"text-center\">
                      <a href='".base_url('vnadmin/product/addtravelstyle/' . $v->id)."'
                    class=\"btn btn-xs btn-default\" title=\"Sửa\"><i class=\"fa fa-pencil\"></i></a>

                <a href='".base_url('vnadmin/product/deletetravelstyle/' . $v->id)."'
                       onclick=\"return confirm('Bạn có chắc chắn muốn xóa?')\"
                       class=\"btn btn-xs btn-danger\"title=\"Xóa\" style=\"color: #fff\"><i class=\"fa fa-times\"></i> </a>
                    </td>
                </tr>";
        ...
        if ($v->parent_id == $parent) {
            ...
            echo "<tr>
                    ...
                    <td class=\"text-center\">
                     ...
                     <div data-toggle='tooltip' data-placement='top' title='Video'
...
function creat_break_crum($module_link='products',$data=null,$id=null){
    ...
    if(is_array($data)&&$id!=null){
        ...
        foreach($data as $key => $row){
            if($row->id==$id){
                $id=$row->parent_id;
                $temp .= '<a href="'.base_url(@$row->alias.'.html').'">  '.@$row->name.' </a>';
                unset($data[$key]);
    ...
    foreach ($data as $k=>$v) {
        ...
        if ($v->parent_id == $parent) {
            ...
            echo "<tr>
                ...
                <td class='text-center'>
                <a href='".base_url('vnadmin/inuser/cat_edit/' . $v->id)."'
                        class=\"btn btn-xs btn-default\" title=\"S?a\"><i class=\"fa fa-pencil\"></i></a>
                <a href='".base_url('vnadmin/inuser/deletecategory/' . $v->id)."'
                       onclick=\"return confirm('Bạn có chắc chắn muốn xóa?')\"
                       class=\"btn btn-xs btn-danger\"title=\"Xóa\" style=\"color: #fff\"><i class=\"fa fa-times\"></i> </a>
                    </td>
                </tr>";
