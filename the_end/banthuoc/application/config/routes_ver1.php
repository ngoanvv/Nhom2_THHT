...
$route['vnadmin'] = 'admin/news/index';
...
//Chat
$route['vnadmin/chat-manager'] = 'admin/chat/chat_manager_admin';
$route['vnadmin/message-offline-manager'] = 'admin/chat/message_offline_manager';
$route['vnadmin/message-offline-manager/(:num)'] = 'admin/chat/message_offline_manager/$1';
$route['vnadmin/message-manager'] = 'admin/chat/message_manager';
$route['vnadmin/message-manager/(:num)'] = 'admin/chat/message_manager/$1';
$route['vnadmin/chat/del-transcript/(:num)/(:any)'] = 'admin/chat/Delete_transcript/$1/$2';
$route['vnadmin/chat-setting'] = 'admin/chat/Chat_setting';
$route['vnadmin/customer-manager'] = 'admin/chat/customer_manager';
$route['vnadmin/customer-manager/(:num)'] = 'admin/chat/customer_manager/$1';
//Chat frontend===========================================================
