    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <ul class="nav navbar-right top-nav">
            ...
            <!--<li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a href="<?/*= base_url('vnadmin/emails')*/?>"> Qu?n lý email</a>
                    </li>
                    <li>
                        <a href="<?/*= base_url('vnadmin/contact/list')*/?>"> Qu?n lý liên h?</a>
                    </li>
                    <li>
                        <a href="<?/*= base_url('vnadmin/imageupload/banner')*/?>">Qu?n lý banner</a>
                    </li>

                    <li>
                        <a href="<?/*= base_url('vnadmin/imageupload')*/?>"> Qu?n lý ?nh</a>
                    </li>
                    <li>
                        <a href="<?/*= base_url('vnadmin/site_option')*/?>">C?u hình h? th?ng</a>
                    </li>
                     <li>
                            <a href="<?/*= base_url('vnadmin/quan-ly-modules')*/?>">Qu?n lý modules</a>
                        </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="divider"></li>
                    <li>
                        <a href="http://localhost/thht/user_management_nhom2/logout"><i class="fa fa-fw fa-power-off" style="color: red"></i> Đăng xuất</a>
                    </li>
                </ul>
            </li>
        </ul>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav menu_admin">
                <li class="">
                    <a href="<?= base_url('vnadmin')?>"><i class="fa fa-fw fa-dashboard"></i>
                        <?/*=lang('home');*/?>Trang chủ
                    </a>
                </li>
                <!--<li>
                    <a href="<?/*= base_url('vnadmin/inuser/categories')*/?>"><i class="fa fa-navicon"></i>
                ...
                <li>
                    <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-navicon"></i>
                        <?/*=lang('admin-title-new');*/?>Quản lý tin tức <i class="fa fa-fw fa-caret-down"></i></a>
                    <ul id="demo" class="collapse">
                        ...
                        <li>
                            <a href="<?= base_url('vnadmin/news/categories')?>">
                ...
                <li>
                    ...
                    fa-navicon"></i>
                        <?/*=lang('mpro');*/?>Quản lý sản phẩm <i class="fa fa-fw fa-caret-down"></i>
                    ...
                    <ul id="product" class="collapse">
                        <li>
                            <a href="<?= base_url('vnadmin/product/add')?>">
                                <?/*=lang('addpro');*/?>Thêm sản phẩm
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url('vnadmin/product/products')?>">
                                <?/*=lang('listpro');*/?>Danh sách sản phẩm
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url('vnadmin/product/categories')?>">
                                <?/*=lang('catepro');*/?>Danh mục sản phẩm
                            </a>
                        </li>
                ...
                <li>
                    <a href="<?= base_url('vnadmin/menu/menulist')?>"><i class="fa fa-navicon"> </i>
                ...
                <!--<li>
                    ...
                    <ul id="media" class="collapse">
                        <li>
                            <a href="<?/*= base_url('vnadmin/media/add')*/?>">
                                Thêm mới
                            </a>
                        </li>
                        <li>
                            <a href="<?/*= base_url('vnadmin/media/listAll')*/?>">
                                Danh sách
                            </a>
                        </li>
                        <li>
                            <a href="<?/*= base_url('vnadmin/media/categories')*/?>">
                                Danh mục
                            </a>
                        </li>
                    </ul>
                ...
                <li>
                    <a href="<?= base_url('vnadmin/pages/pagelist')?>"><i class="fa fa-navicon"></i>
                        <?/*=lang('m_content');*/?>Quản lý nội dung
                    </a>
                </li>
                <li>
                    <a href="<?= base_url('vnadmin/imageupload/banners')?>"><i class="fa fa-navicon"></i>
                        <?/*=lang('m_banner');*/?>Quản lý banner
                    </a>
                </li>
                <li>
                    <a href="<?= base_url('vnadmin/contact/contacts')?>"><i class="fa fa-navicon"></i>
                ...
                <li>
                    ...
                    <ul id="banner" class="collapse">
                        <li>
                            <a href="<?= base_url('vnadmin/users/emails')?>">
                                <?/*=lang('m_email');*/?>Quản lý email
                            </a>
                        </li>

                        <li>
                            <a href="<?= base_url('vnadmin/site_option')?>">
                                <?/*=lang('m_sys');*/?>Cấu hình hệ thống
                            </a>
                        </li>
                       <li>
                            <a href="<?= base_url('vnadmin/support_online/listSuport')?>"><?=lang('support');?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url('vnadmin/admin/bando_map')?>">Cấu hình bản đồ map</a>
                        </li>
                    </ul>
                </li>
                <!--<li>
