        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="text-left" style="padding-bottom: 15px">
                    <a href="<?= base_url('vnadmin/map/add')?>" class="btn btn-success btn-xs">
                            ...
                            foreach($pagelist as $v){
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('vnadmin/map/edit/'.$v->id)?>" class="btn btn-xs btn-default">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <a href="<?= base_url('vnadmin/map/delete/'.$v->id)?>" class="btn btn-xs btn-danger">
