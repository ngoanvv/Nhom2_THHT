                                ...
                                foreach ($newslist as $v) {
                                    ...
                                    <tr>
                                        ...
                                        <td width='8%' class="text-center">
                                            ...
                                            <a href="<?= base_url('vnadmin/news/edit/' . $v->id) ?>" class="btn btn-xs btn-default" title="Sửa"><i class="fa fa-pencil"></i></a>

                                            <a href="<?= base_url('vnadmin/news/delete/' . $v->id) ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" class="btn btn-xs btn-danger" title="Xóa" style="color: #fff"><i class="fa fa-times"></i> </a>
