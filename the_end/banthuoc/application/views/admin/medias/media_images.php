        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?= base_url('vnadmin/media/listAll') ?>">Danh mục tài liệu</a>
                    </li>
                    <li>
                        <a href="<?= base_url('vnadmin/media/images') ?>">Tài liệu</a>
                    </li>
                </ol>
            </div>
            <div class="clear"></div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-xs">
                                        ...
                                        <a href="<?= base_url('vnadmin/media/delete/' . $v1->img_id) ?>"
