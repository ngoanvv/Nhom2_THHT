    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="col-sm-12">Dòng :</label>
                        <div class="col-sm-12">
                            <input type="text" value="<?= @$edit->code; ?>" name="code" id="pro_code" class="form-control input-sm"/>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
               ...
               <!-- <div class="col-md-4">
                    <div class="form-group">
                        <label for="inputcontent" class="col-sm-12  -label">Kích thước</label>

                        <div class="col-sm-12">
                            <input type="text" name="bought" class="form-control input-sm"
                                   value="<?= @$edit->bought;?>"/>
                        </div>
                    </div>
                </div>
...
-->
            ...
            <div class="form-group">
                <div class="col-sm-12 ">
                    <label for="inputcontent" class=" control-label">Kích thước:</label>
    ...
    function editItem()
    {
        ...
        if($('#form-bk').validationEngine('validate')){
            $.ajax({
                type: "POST",
                dataType: "json",
                url: base_url() + 'vnadmin/alias/checkProEdit',
