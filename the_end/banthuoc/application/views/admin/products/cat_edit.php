                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <div class="pull-right">
                                        <button type="submit" onclick="updateCate()" class="btn btn-success btn-xs" name="addcate"><i
                                ...
                                <div class="panel-body" style="min-height: 530px">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <button type="submit" onclick="updateCate()" class="btn btn-success btn-xs" name="add_cate"><i
                                                class="fa fa-check"></i> <?=$btn_name;?></button>
                                    </div>
                                </div>
                            </div>
    ...
    function updateCate()
    {
        ...
        if($('#form-bk').validationEngine('validate')){
            $.ajax({
                type: "POST",
                dataType: "json",
                url: base_url() + 'vnadmin/alias/checkCateProEdit',
