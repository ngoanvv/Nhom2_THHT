        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?= base_url('vnadmin/product/products') ?>">Sản phẩm</a>
                    </li>
                    <li>
            ...
            <div class="col-md-12">
                <table class="table table-hover">
                    ...
                    <?php if (count($pro_image) && !empty($pro_image)) {
                        $s=1;
                        foreach ($pro_image as $v1) {
                            ...
                            <tr>
                                <td><?= $s++; ?></td>
                                <td>
                                    <img src="<?= base_url($link.'thumbnail_3_'.$v1) ?>"/>
                                </td>
                                ...
                                <td>
                                    <div class="btn-group btn-group-xs">
                                       <!-- <a onclick="getModal(<?/*=$v1->img_id;*/?>)"
                                        ...
                                        <a href="<?= base_url('vnadmin/product/deleteImgPro?id=' . @$id.'&img='.@$v1) ?>"
