// -----
// The `timezoneJS.Date` object gives you full-blown timezone support, independent from the timezone set on the end-home111's machine running the browser. It uses the Olson zoneinfo files for its timezone data.
//
...
(function () {
  ...
  timezoneJS.Date.prototype = {
    ...
    // Time adjusted to home111-specified timezone
    getTime: function () {
