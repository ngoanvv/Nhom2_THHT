		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<div class="col-md-3">
						<a href="<?php echo site_url('appointment/appointment_report_excel_export/'.date('Y-m-d',strtotime($from_date)).'/'.date('Y-m-d',strtotime($to_date)).'/'.$doctor_id);?>" name="excel_export" class="btn btn-primary">Export to Excel</a>
					</div>
					<?php echo form_close(); ?>
				</div>
			</div>
